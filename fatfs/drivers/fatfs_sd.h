...
#define FATFS_CS_PORT						SDCARD_SPI_PORT
#define FATFS_CS_PIN						SDCARD_SPI_CS_PIN
#endif
...
#define FATFS_USE_DETECT_PIN_PORT			SDCARD_CD_PORT
#define FATFS_USE_DETECT_PIN_PIN			SDCARD_CD_PIN
#endif
#endif

#if FATFS_USE_WRITEPROTECT_PIN > 0
#ifndef FATFS_USE_WRITEPROTECT_PIN_PIN
#define FATFS_USE_WRITEPROTECT_PIN_RCC		RCC_AHB1Periph_GPIO..
#define FATFS_USE_WRITEPROTECT_PIN_PORT		GPIO..
#define FATFS_USE_WRITEPROTECT_PIN_PIN		GPIO_Pin_..
#endif
#endif
